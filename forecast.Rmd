...
(emp.change.plot <- hc_params %>% 
  ...
  hc_title(text = "Monthly Change in US Non_Farm Payrolls (000s)", align = alignment) %>%
...
text(n+2, sarima$pred-35, "176", col="blue")

#adding reg.arma  forecast points and lines
points(n+1, 205.012, col = "green")
text(n+2, 205.012 + 35, "205", col="green")
...
In addition to some auto-regressive models, I develop a regression forecast with ARMA Errors using some leading indicators:
